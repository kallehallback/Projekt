...
public class Archive {
    public Author readAuthor() {
        ...
        String name = "";
        String mail = "";
        Path path = Path.of("src/main/java/Program/Archive/author.txt");
    ...
    public Blog readPosts() {
        ...
        String text = "";
        Blog blogg = new Blog();
        Path path = Path.of("src/main/java/Program/Archive/posts.txt");
        try(BufferedReader br = Files.newBufferedReader(path)) {
            String line;
            while ((line=br.readLine()) != null) {
    ...
    public void writePost(String title, String text){
        ...
        String name = author.getName();
        Path path = Path.of("src/main/java/Program/Archive/posts.txt");
        try(BufferedWriter writer = new BufferedWriter(new FileWriter("src/main/java/Program/Archive/posts.txt", true))) {
            writer.newLine();
